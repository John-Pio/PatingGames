<footer>
  <div class="container">
    <section class="copyright">
      <svg class="logo" width="150" height="150" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800">
    ...
    <section class="icons">
      <h4>Follow Us</h4>
      <ul role="list">
        <li><a href="https://www.facebook.com"><svg class="svg" xmlns="http://www.w3.org/2000/svg" width="20" height="20">
              <path d="M20 10.061C20 4.505 15.523 0 10 0S0 4.505 0 10.061C0 15.083 3.657 19.245 8.438 20v-7.031H5.898v-2.908h2.539V7.845c0-2.522 1.493-3.914 3.777-3.914 1.094 0 2.238.197 2.238.197v2.476h-1.261c-1.242 0-1.63.776-1.63 1.571v1.887h2.773l-.443 2.908h-2.33V20C16.343 19.245 20 15.083 20 10.061z" />
            </svg></a></li>
        <li><a href="https://twitter.com"><svg class="svg" width="20" height="20" viewBox="0 0 1200 1227" fill="#000" xmlns="http://www.w3.org/2000/svg">
              <path d="M714.163 519.284L1160.89 0H1055.03L667.137 450.887L357.328 0H0L468.492 681.821L0 1226.37H105.866L515.491 750.218L842.672 1226.37H1200L714.137 519.284H714.163ZM569.165 687.828L521.697 619.934L144.011 79.6944H306.615L611.412 515.685L658.88 583.579L1055.08 1150.3H892.476L569.165 687.854V687.828Z" />
            </svg>
          </a></li>
        <li><a href="https://discord.com/"><svg class="svg" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 127.14 96.36">
        ...
        <li><a href="https://github.com/John-Pio/PatingGames"><svg class="svg" width="20" height="20" viewBox="0 0 16 16">
