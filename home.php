...
<body>
  ...
  <main>
    ...
    <dialog id="add-dialog">
      <h3>Add A Game!</h3>
      <form action="components/create.php" method="post" enctype=multipart/form-data>
    ...
    <dialog id="edit-dialog">
      ...
      <form action="update.php" method="post">
        ...
        <input type="text" id="editTitle" name="editTitle" value="<?= $gameData['title'] ?>" required>

        <label for="editDescp">Description:</label>
        <input type="text" id="editDescp" name="editDescp" value="<?= $gameData['descp'] ?>" required>

        <label for="editTags">Tags:</label>
        <input type="text" id="editTags" name="editTags" value="<?= $gameData['tags'] ?>" required>

        <!-- Add more input fields for other properties -->
        <button type="button" id="close-edit-dialog">Close</button>
      ...
      function renderGames($game)
      {
        echo "<li class='card'>
          ...
          <div class='info'>
            ...
            <button class='edit-button' data-game-id='{$game->id}'>Edit</button>
